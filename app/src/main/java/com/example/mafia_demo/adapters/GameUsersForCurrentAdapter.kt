...
interface GameUserActionListener {
    fun onUserDelete(user: PlayerResponse)
}

class GameUsersForCurrentAdapter(val playerPosition: Int?, private val actionListener: GameUserActionListener) :
    RecyclerView.Adapter<GameUsersForCurrentAdapter.UsersViewHolder>(), View.OnClickListener {
